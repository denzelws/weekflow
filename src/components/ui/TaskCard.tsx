...
export function TaskCard({
  ...
  const isDisabled  = isCompleted || (!isSelected && selectable && selectedCount >= 3)
  ...
  return (
    <div
      className={cn(
        ...
        isDisabled && !isSelected && 'opacity-40 cursor-not-allowed hover:bg-surface-low',
        className,
      )}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {isCompleted && (
          <span className="text-label text-success mt-0.5 block">Concluída</span>
        )}
